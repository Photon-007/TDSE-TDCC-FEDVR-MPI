...
20  r9lgmc = 0.0D0
  ...
  SUBROUTINE gamlim(xmin,xmax)
    ...
    IMPLICIT REAL(DOUB_PREC)(a-h,o-z)
    REAL(DOUB_PREC), INTENT(OUT)                        :: xmin
    REAL(DOUB_PREC), INTENT(OUT)                        :: xmax
...
40  xmax = xmax - 0.01D0
  ...
  FUNCTION inits(os,nos,eta)
    ...
    IMPLICIT REAL(DOUB_PREC) (a-h,o-z)
    REAL(DOUB_PREC), INTENT(IN OUT)                     :: os(nos)
    INTEGER, INTENT(IN)                      :: nos
    REAL(DOUB_PREC), INTENT(IN)                         :: eta
